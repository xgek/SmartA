...
#[derive(Debug)]
pub struct AIAssistProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AIAssistProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AIAssist processing");
    
    let mut processor = AIAssistProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AIAssistProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AIAssistProcessor::new(false);
